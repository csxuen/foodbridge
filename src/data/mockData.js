...
export const foodListings = [
  ...
  { id: 'f1_2', donorId: 'd1', name: 'Gourmet Tuna Sandwiches', category: 'Bakery', quantity: 8, unit: 'portions', expiry: new Date(Date.now() + 2 * 3600000).toISOString(), allergyTags: ['Gluten', 'Fish'], distance: 1.2, imageUrl: 'https://images.unsplash.com/photo-1628191137573-dee64e727614?w=400&q=80', status: 'Active', pickupSlots: [{ date: 'Today', start: '15:00', end: '17:00' }] },
  { id: 'f1_3', donorId: 'd1', name: 'Batch of Chocolate Croissants', category: 'Bakery', quantity: 12, unit: 'pieces', expiry: new Date(Date.now() + 1.5 * 3600000).toISOString(), allergyTags: ['Gluten', 'Dairy'], distance: 1.2, imageUrl: 'https://images.unsplash.com/photo-1549996647-190b679b33d7?w=400&q=80', status: 'Claimed', pickupSlots: [{ date: 'Today', start: '13:00', end: '15:00' }] },
  { id: 'f1_4', donorId: 'd1', name: 'Whole Custom Birthday Cake', category: 'Bakery', quantity: 1, unit: 'portions', expiry: new Date(Date.now() - 24 * 3600000).toISOString(), allergyTags: ['Gluten', 'Dairy', 'Eggs'], distance: 1.2, imageUrl: 'https://images.unsplash.com/photo-1535141192574-5d4897c12636?w=400&q=80', status: 'Completed', pickupSlots: [{ date: 'Yesterday', start: '10:00', end: '12:00' }] },
  { id: 'f1_5', donorId: 'd1', name: 'Surplus Blueberry Muffins', category: 'Bakery', quantity: 20, unit: 'pieces', expiry: new Date(Date.now() - 48 * 3600000).toISOString(), allergyTags: ['Gluten', 'Dairy'], distance: 1.2, imageUrl: 'https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=400&q=80', status: 'Expired', pickupSlots: [{ date: '2 Days Ago', start: '16:00', end: '18:00' }] },
